...
JustGage = function(config) { 
  ...
  this.config = 
  {
    ...
    titleFontColor : (config.titleFontColor) ? config.titleFontColor : "#000000",
    ...
    valueFontColor : (config.valueFontColor) ? config.valueFontColor : "#000000",
    ...
    labelFontColor : (config.labelFontColor) ? config.labelFontColor : "#000000",
