    ...
    <div>
		...
		<header>
			...
			<div id="content">
				...
				<article>
					<h3>Composting and Recycling Dashboard</h3>
                    <p>&nbsp;</p>
                    <img src="img/chart.png" alt="Chart" id="chart" />
			...
			<div id="sidebar">
                ...
                <aside>
                    <img src="http://www.jlion.com:80//tools/Thermometer.aspx?MIN=0&MAX=200000&VT=1&T=Thermometer Chart&IV=170000&M=1&SC=0&CS=6&CI=en-US&TH=1" style="border: solid 1px black;" alt="Scholarships Fund" title="Scholarships Fund" width="240" height="425"/>
                </aside>
